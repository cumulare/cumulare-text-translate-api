...
from cumulare_text_translate_api.gunicorn_runner import GunicornApplication
from cumulare_text_translate_api.settings import settings
...
def main() -> None:
    ...
    if settings.reload:
        uvicorn.run(
            "cumulare_text_translate_api.web.application:get_app",
